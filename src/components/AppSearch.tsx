...
export default function AppSearch({ 
  ...
  const apps: AppLink[] = [
    ...
    },
    {
      ...
      description: "Calculate loan interests (SME, Personal, etc.) and manage rate history.",
    ...
    {
      title: "KPI",
      description: "Track and monitor Key Performance Indicators for your branch.",
      href: "/apps/kpi",
      color: "indigo",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Letters",
      description: "Create and manage official letters in English and Bangla.",
      href: "/apps/letters",
      color: "blue",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "My Passwords",
      description: "Securely store and manage your login credentials and notes.",
      href: "/apps/passwords",
      color: "rose",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
